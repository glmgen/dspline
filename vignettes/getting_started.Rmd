...
## Smoothing with discrete splines
...
terms of efficiency and numerical stability.
...
rather than letting this be dictated by a given fixed knot sequence. See the 
[trendfilter](https://github.com/glmgen/trendfilter) package for more details.

## Interpolation with discrete splines
