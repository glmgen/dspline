...
static int _dspline_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        signatures.insert("List(*rcpp_b_mat)(int,NumericVector,bool,IntegerVector,bool)");
        signatures.insert("List(*rcpp_h_mat)(int,NumericVector,bool,IntegerVector)");
        signatures.insert("List(*rcpp_n_mat)(int,NumericVector,bool,IntegerVector)");
        signatures.insert("List(*rcpp_h_eval)(int,NumericVector,NumericVector,IntegerVector)");
