...
namespace dspline {
    ...
    inline List rcpp_b_mat(int k, NumericVector xd, bool tf_weighting, IntegerVector row_idx, bool d_only) {
        typedef SEXP(*Ptr_rcpp_b_mat)(SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_rcpp_b_mat p_rcpp_b_mat = NULL;
        if (p_rcpp_b_mat == NULL) {
            validateSignature("List(*rcpp_b_mat)(int,NumericVector,bool,IntegerVector,bool)");
    ...
    inline List rcpp_h_mat(int k, NumericVector xd, bool di_weighting, IntegerVector col_idx) {
        typedef SEXP(*Ptr_rcpp_h_mat)(SEXP,SEXP,SEXP,SEXP);
        static Ptr_rcpp_h_mat p_rcpp_h_mat = NULL;
        if (p_rcpp_h_mat == NULL) {
            validateSignature("List(*rcpp_h_mat)(int,NumericVector,bool,IntegerVector)");
    ...
    inline List rcpp_n_mat(int k, NumericVector xd, bool normalized, IntegerVector knot_idx) {
        typedef SEXP(*Ptr_rcpp_n_mat)(SEXP,SEXP,SEXP,SEXP);
        static Ptr_rcpp_n_mat p_rcpp_n_mat = NULL;
        if (p_rcpp_n_mat == NULL) {
            validateSignature("List(*rcpp_n_mat)(int,NumericVector,bool,IntegerVector)");
    ...
    inline List rcpp_h_eval(int k, NumericVector xd, NumericVector x, IntegerVector col_idx) {
        typedef SEXP(*Ptr_rcpp_h_eval)(SEXP,SEXP,SEXP,SEXP);
        static Ptr_rcpp_h_eval p_rcpp_h_eval = NULL;
        if (p_rcpp_h_eval == NULL) {
            validateSignature("List(*rcpp_h_eval)(int,NumericVector,NumericVector,IntegerVector)");
